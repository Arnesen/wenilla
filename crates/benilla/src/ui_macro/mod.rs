...
use benilla_ui::script::{MacroState, UiScript};
...
/// nothing else today. Each body line is pushed onto the chat-input queue in order, which is where
/// a typed line arrives; [`run`]'s module doc is why. Returns whether anything ran.
